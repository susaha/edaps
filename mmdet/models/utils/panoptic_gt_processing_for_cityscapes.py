...
def preprocess_panoptic_gt_for_cityscapes(gt_labels, gt_masks, gt_semantic_seg, img_metas, cityscapes_thing_list, num_classes):
    ...
    for label in semantic_labels:
        if label not in cityscapes_thing_list and label < num_classes: # this will exclude 255 void id
